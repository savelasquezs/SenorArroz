...
-- Tabla bank_transfer (movimientos entre bancos; un extremo NULL = efectivo de caja / ExpectedCash)
CREATE TABLE IF NOT EXISTS bank_transfer (
    ...
    CONSTRAINT chk_bank_transfer_endpoints CHECK (
...
-- Préstamos informales por sucursal (vigentes; el efectivo esperado los descuenta; no se duplican en cada cierre)
...
-- Movimientos Caja Mayor Efectivo (tipo bank CashVault): abonos/descargas sin transferencia interbancaria
