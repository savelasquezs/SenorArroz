...
-- modificaciones de las migraciones EF (supplier.branch_id, expense_header.created_by_id,
-- supplier_expense, deliveryman_advance, verified_at, guestname, is_primary, etc.).
--
-- =============================================================================
...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM bank WHERE branch_id = branch_id_var LIMIT 1) THEN
        INSERT INTO bank (branch_id, name, image_url, active) VALUES (branch_id_var, 'Bancolombia', NULL, true);
    END IF;
END $$;
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion") VALUES
    ('20251122122758_InitialSchema', '9.0.8'),
    ('20251122123044_CreateDatabaseFunctionsAndTriggers', '9.0.8'),
    ('20251122123208_SeedInitialData', '9.0.8'),
    ('20251128005639_AddDeliverymanAdvanceTable', '9.0.8'),
    ('20251128025240_AddCreatedByIdToExpenseHeader', '9.0.8'),
    ('20251129224645_AddSupplierExpense', '9.0.8'),
    ('20251130000000_AddBranchIdToSupplier', '9.0.8')
