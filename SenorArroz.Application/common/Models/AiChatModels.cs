...
public record WhatsAppProductMatchResult(string NormalizedQuery,int? ServesPeople,bool ExactMatch,bool ApproximateMatch,bool NeedsClarification,IReadOnlyList<WhatsAppProductMatchCandidate> Products,bool ServesPeopleUnavailable=false);
