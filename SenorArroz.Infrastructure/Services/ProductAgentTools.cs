...
public class SearchProductsAgentTool(IWhatsAppProductMatcher matcher):IAgentTool
{
 ...
 public JsonElement ParametersSchema=>JsonDocument.Parse("""{"type":"object","properties":{"query":{"type":"string","maxLength":150},"servesPeople":{"type":"integer","minimum":1},"limit":{"type":"integer","minimum":1,"maximum":10}},"additionalProperties":false}""").RootElement.Clone();
