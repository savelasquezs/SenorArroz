...
public class WhatsAppAiInvocationConfiguration : IEntityTypeConfiguration<WhatsAppAiInvocation>
{
    public void Configure(EntityTypeBuilder<WhatsAppAiInvocation> b)
    {
        ...
        b.Property(x => x.InputTokens).HasColumnName("input_tokens"); b.Property(x => x.CachedInputTokens).HasColumnName("cached_input_tokens"); b.Property(x => x.OutputTokens).HasColumnName("output_tokens"); b.Property(x => x.ThinkingTokens).HasColumnName("thinking_tokens");
