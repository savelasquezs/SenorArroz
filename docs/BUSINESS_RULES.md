...
- La cobertura exige cumplir simultáneamente una distancia de ruta de Google de máximo 5 km y un desplazamiento de máximo 30 minutos. El mapa representa un círculo azul de 5 km por sucursal, pero el backend conserva la ruta de Google como fuente de verdad para la cotización.
...
- El mensaje de domicilio incluye cliente, teléfono, dirección confirmada, enlace de Google Maps, sucursal, carrito, precios vigentes, tiempo y valor estimado del domicilio. No incluye textos de fuera de cobertura ni consentimientos; el cajero vuelve a validar la viabilidad. El mensaje de recogida incluye únicamente cliente, teléfono, sucursal y dirección de recogida, tiempo de preparación y carrito.
